<?php
require_once(__DIR__.'/../../app/libraries/api.php');
require_once(__DIR__.'/../../vendor/autoload.php');
require_once(__DIR__.'/../../app/libraries/date_helper.php');
require_once(__DIR__.'/../../app/libraries/db.php');
...
if($enabled) {
	...
	for($i=0; $i < count($jsonData); $i++) {
		...
		if (empty($profit) || ($profit['trade_count'] == 0)) {
			echo "No profit data<br/>";
			continue;
		}
	...
	printf("Inserted %d document(s)<br/>", $operation_insert->getInsertedCount());
}